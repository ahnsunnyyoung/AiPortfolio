                          ...
                          {message.content.includes("More details") && (
                            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl border border-blue-200 overflow-hidden shadow-lg">
                              <div className="p-8">
                                ...
                                {/* Project Image */}
                                {project.img && (
                                  <div className="mb-8 rounded-xl overflow-hidden border border-gray-200 shadow-md">
                                    <img
                                      src={project.img}
                                      alt={project.imgAlt}
                                ...
                                <div className="mb-8">
                                  ...
                                  <div className="bg-white/70 rounded-lg p-6 border border-blue-100">
                                    <p className="text-gray-700 leading-relaxed text-lg">{project.summary}</p>
                                  </div>
                                </div>
                                ...
                                {project.contents && project.contents.length > 0 && (
                                  <div className="mb-8">
                                    ...
                                    <div className="bg-white/70 rounded-lg p-6 border border-green-100">
                                  ...
                                  <div className="bg-white/70 rounded-lg p-6 border border-purple-100">
                                    <div className="flex flex-wrap gap-3">
                                      {project.tech.split('/').map((tech, index) => (
                                        <span
                                          key={index}
                                          className="px-4 py-2 bg-gradient-to-r from-purple-500 to-blue-500 text-white text-sm rounded-full font-medium shadow-sm hover:shadow-md transition-shadow"
                                        >
                                          {tech.trim()}
                                        </span>
                                      ))}
                                ...
                                <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg p-6 border border-gray-200">
                                  <div className="grid md:grid-cols-3 gap-6 text-center">
                                    <div>
                                      ...
                                      <div className="text-sm text-gray-600">반응형 디자인</div>
                                    </div>
                                    <div>
                                      <div className="text-2xl font-bold text-green-600 mb-1">Fast</div>
                                      <div className="text-sm text-gray-600">로딩 속도</div>
                                    </div>
                                    <div>
                                      <div className="text-2xl font-bold text-purple-600 mb-1">Modern</div>
                ...
                <div className="bg-gray-50 rounded-2xl rounded-tl-md px-6 py-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-500">
                      {askMutation.isPending ? "Processing..." : "Thinking..."}
                    </span>
                  </div>
                </div>
              </div>
