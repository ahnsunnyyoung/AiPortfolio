    ...
    return (
      <div className="min-h-screen portfolio-gradient flex flex-col items-center justify-center px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* AI Agent Card */}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 mb-8 transition-all duration-500 ease-out">
            {/* Collapsed State */}
            {!isCardExpanded && (
              <div 
                className="p-6 cursor-pointer hover:bg-white/90 transition-all duration-300"
                onClick={expandCard}
              >
                <div className="flex items-center justify-center gap-3">
                  ...
                  <div className="text-center">
                    <h2 className="text-lg font-semibold text-gray-800">Chat with AI Agent</h2>
